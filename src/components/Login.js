...
// here you import that actual function(s) that are responsible for changing the state
...
export const Login = () => {
  ...
  return (
    <div>
      ...
      <button
      // whenever this button is clicked, the state in the store is changed via the logout function
